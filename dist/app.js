...
class Project {
    constructor(id, title, descrition, people, status) {
        this.id = id;
        this.title = title;
...
class ProjectState extends State {
    ...
    addProject(title, desciption, numOfPeople) {
        const newProject = new Project(crypto.randomUUID().toString(), title, desciption, numOfPeople, ProjectStatus.Active);
...
class ProjectItem extends Component {
    ...
    renderContent() {
        ...
        this.element.querySelector('p').textContent = this.project.descrition;
    }
}
__decorate([
    autobind
